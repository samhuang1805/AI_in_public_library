...
folium_static(library_map, width=1500, height=950)
...
<div style='text-align: center;'>
    ...
    <a href='https://twitter.com/CTGUAlbany' target='_blank'>
        <img src='https://upload.wikimedia.org/wikipedia/commons/5/53/X_logo_2023_original.svg' alt='X-logo' style='width:64px;height:64px;margin:0 10px;'>
    </a>
    <a href='https://www.linkedin.com/company/ctg-ualbany/' target='_blank'>
        <img src='https://upload.wikimedia.org/wikipedia/commons/8/81/LinkedIn_icon.svg' alt='LinkedIn' style='width:64px;height:64px;margin:0 10px;'>
    </a>
</div>
"""
