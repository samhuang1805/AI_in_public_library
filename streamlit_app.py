...
st.sidebar.write("Use the filters below to narrow down the AI programs and services shown on the map. If you encounter any issues, please feel free to contact research assistant Zong-Xian Huang at zhuang7@albany.edu.")
...
folium_static(library_map, width=900, height=900)
...
<div style='text-align: center;'>
    <a href='https://ctgualbany.my.canva.site/imls-website' target='_blank'>
        <img src='https://upload.wikimedia.org/wikipedia/commons/7/70/Applications-internet.svg' alt='homepage' style='width:48px;height:48px;margin:0 10px;'>
    </a>
